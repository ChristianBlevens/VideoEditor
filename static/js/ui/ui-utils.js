...
export function showToast(message, type = 'info', duration = 3000) {
    ...
    // Auto-hide after duration for non-progress toasts
    if (duration && !message.includes('...')) {
        setTimeout(() => {
            hideToast();
        }, duration);
    }
...
export async function handleTimelineScroll(e) {
    ...
    const { updateAllTimelineElements, updatePlayheadPosition, updateInOutMarkers, generateTimeMarkers } = await import('../features/timeline/timeline.js');

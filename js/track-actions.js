...
async function undoAction(actionId) {
    ...
    const { undo } = await import('./history-manager.js');
...
async function undoSplitAction(action) {
    const { getClip, deleteClip, createClip, getClipTranscripts, updateTranscript, createTranscript } = await import('./operations.js');

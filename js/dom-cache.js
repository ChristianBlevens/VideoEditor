...
export const elements = {
    ...
    findFillerBtn: document.getElementById('find-filler-btn'),
    findProfanityBtn: document.getElementById('find-profanity-btn'),
    findPausesBtn: document.getElementById('find-pauses-btn'),
